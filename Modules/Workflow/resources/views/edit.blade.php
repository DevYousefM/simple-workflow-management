...
@section('content')
    <div class="contents">
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-main user-member justify-content-sm-between ">
                        ...
                        <div class="action-btn d-flex" style="gap: 10px">
                            <button id="updateWorkflow" type="button" class="btn btn-success">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="name" name="name" value="{{ old('name', $workflow->name) }}">
                                            @error('name')
                                        ...
                                        <select name="course_id" id="course_id" class="form-control form-control-lg">
                                            ...
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ old('course_id', $workflow->course_id) == $course->id ? 'selected' : '' }}>
                                                    {{ $course->name }}
                                                </option>
                                            @endforeach
                                        </select>
        ...
        @include('workflow::steps.steps', ['workflow' => $workflow])
...
@section('js')
    ...
    @include('workflow::scripts.edit_scripts')
@endsection
