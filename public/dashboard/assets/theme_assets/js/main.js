...
function slugify(string) {
    return string
        ...
        .replace(/[^\p{L}\p{N}\s-]/gu, "") // Remove special characters, allow letters and numbers
        .replace(/\s+/g, "-") // Replace spaces with hyphens
        .replace(/-+/g, "-"); // Remove multiple hyphens
}
function activateSearchInput(url, tableId, paginationId) {
    let typingTimer;
